...
const SkillData =  [
     {
       ...
       Skill_Description:
         "Front-end and back-end development using HTML, CSS, JavaScript, and Python",
       Sub_skills: [
         {
           name: "Front-end Development",
           sub: ["HTML", "CSS", "JavaScript", "React", "Vue", "Angular"],
         },
         {
           name: "Back-end Development",
           sub: ["Node.js", "Express", "Django", "Flask", "Ruby on Rails"],
         },
       ],
     },
     {
       ...
       Sub_skills: [
         {
           name: "Data Analysis",
           sub: ["Pandas", "NumPy", "Data Visualization"],
         },
         {
           name: "Machine Learning",
           sub: ["Scikit-learn", "TensorFlow", "PyTorch"],
         },
       ],
     },
     {
       ...
       Skill_Description:
         "Creating visually appealing designs for websites and marketing materials",
       Sub_skills: [
         {
           name: "Tools",
           sub: ["Adobe Photoshop", "Adobe Illustrator", "Sketch", "Figma"],
         },
         {
           name: "Typography",
           sub: ["Typography Basics", "Font Pairing"],
         },
       ],
     },
     {
     ...
     },
     {
       ...
       Skill_name: "DevOps",
       Skill_Description:
         "Automating deployment pipelines and managing infrastructure",
       Sub_skills: [],
     },
     {
       Skill_id: 9,
